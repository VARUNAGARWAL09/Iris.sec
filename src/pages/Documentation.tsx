...
const Documentation = () => {
  ...
  const handleDownloadTrainingData = () => {
    // Generate training data PDF
    generateTrainingDataPDF();
  };

  const generateTrainingDataPDF = () => {
    ...
    // Create PDF content
    const pdfContent = `
SOC Alert Classification - Training Data Documentation
=====================================================

Dataset Information:
- Name: ${trainingData.dataset}
- Total Samples: ${trainingData.totalSamples}
- Features: ${trainingData.features}
- Models: ${trainingData.models.join(', ')}
- Best Accuracy: ${trainingData.accuracy}
- Last Updated: ${trainingData.lastUpdated}

Data Split:
- Training: ${trainingData.dataSplit.training}
- Validation: ${trainingData.dataSplit.validation}
- Testing: ${trainingData.dataSplit.testing}

Feature Engineering:
${trainingData.featureEngineering.map((feature, i) => `${i + 1}. ${feature}`).join('\n')}

Model Performance:
1. XGBoost: 95.25% accuracy, 15.2ms inference
2. Random Forest: 93.56% accuracy, 12.8ms inference
3. Logistic Regression: 95.25% accuracy, 8.5ms inference
...
- Synthetic data generation based on real SOC patterns
...
Generated by IRIS.SEC Incident Response Hub
${new Date().toLocaleString()}
    ...
    a.href = url;
    a.download = 'SOC_ML_Training_Data_Documentation.txt';
                ...
                <div className="p-4 border rounded-lg">
                  ...
                  <div className="space-y-2 text-sm">
                    <div className="flex justify-between">
                      ...
                      <span className="font-mono">95.25%</span>
                    </div>
                    <div className="flex justify-between">
        ...
        <Card className="print:shadow-none print:border-gray-300">
          ...
          <CardContent className="space-y-6">
            ...
            <div>
              ...
              <p className="text-sm text-muted-foreground mb-4">
                Our ML system employs a sophisticated ensemble approach combining three distinct algorithms
                to provide accurate and reliable threat severity predictions. Each model brings unique strengths
                to create a comprehensive analysis framework.
              </p>
              
              <div className="grid md:grid-cols-3 gap-4">
                <div className="p-4 border rounded-lg">
                  <h4 className="font-semibold mb-2 text-green-400">XGBoost</h4>
                  <p className="text-sm text-muted-foreground mb-2">
                    Gradient boosting with superior accuracy and interpretability
                  </p>
                  <div className="text-xs space-y-1">
                    <p><strong>Accuracy:</strong> 95.25%</p>
                    <p><strong>Inference Time:</strong> 15.2ms</p>
                    <p><strong>Strength:</strong> Best overall performance</p>
                  </div>
                </div>
                <div className="p-4 border rounded-lg">
                  <h4 className="font-semibold mb-2 text-blue-400">Random Forest</h4>
                  <p className="text-sm text-muted-foreground mb-2">
                    Ensemble decision trees with robust noise handling
                  </p>
                  <div className="text-xs space-y-1">
                    <p><strong>Accuracy:</strong> 93.56%</p>
                    <p><strong>Inference Time:</strong> 12.8ms</p>
                    <p><strong>Strength:</strong> Consistent performance</p>
                  </div>
                </div>
                <div className="p-4 border rounded-lg">
                  <h4 className="font-semibold mb-2 text-orange-400">Logistic Regression</h4>
                  <p className="text-sm text-muted-foreground mb-2">
                    Fast linear model with excellent speed-accuracy tradeoff
                  </p>
                  <div className="text-xs space-y-1">
                    <p><strong>Accuracy:</strong> 95.25%</p>
                    <p><strong>Inference Time:</strong> 8.5ms</p>
                    <p><strong>Strength:</strong> Fastest inference</p>
                  </div>
                </div>
              </div>
            </div>
              ...
              <div className="bg-slate-50 dark:bg-slate-800 p-4 rounded-lg">
                <div className="space-y-3 text-sm">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      <p className="font-medium">Alert Ingestion</p>
                      <p className="text-xs text-muted-foreground">Real-time alerts processed from SIEM systems</p>
                    </div>
                  </div>
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-xs text-muted-foreground">11 derived features including threat index, login rates, and byte patterns</p>
                    </div>
                  </div>
                  <div className="flex items-center gap-3">
                    <div className="w-8 h-8 bg-orange-500 text-white rounded-full flex items-center justify-center text-xs font-bold">3</div>
                    <div>
                      <p className="font-medium">Multi-Model Prediction</p>
                      <p className="text-xs text-muted-foreground">Simultaneous inference across all three models</p>
                    </div>
                  </div>
                  <div className="flex items-center gap-3">
                    <div className="w-8 h-8 bg-purple-500 text-white rounded-full flex items-center justify-center text-xs font-bold">4</div>
                    <div>
                      <p className="font-medium">Ensemble Scoring</p>
                      <p className="text-xs text-muted-foreground">Weighted combination: XGBoost (50%), Random Forest (30%), Logistic Regression (20%)</p>
                    </div>
                  </div>
                  <div className="flex items-center gap-3">
                    <div className="w-8 h-8 bg-red-500 text-white rounded-full flex items-center justify-center text-xs font-bold">5</div>
                    <div>
                      <p className="font-medium">Result Storage</p>
                      <p className="text-xs text-muted-foreground">Cached in database with 5-minute TTL for performance optimization</p>
                    </div>
                  </div>
                </div>
              </div>
            ...
            <div>
              ...
              <div className="grid md:grid-cols-2 gap-4">
                <div className="space-y-3">
                  <h4 className="font-medium text-sm">Caching Layer</h4>
                  <ul className="text-xs text-muted-foreground space-y-1">
                    <li>• Prediction results cached for 5 minutes</li>
                    <li>• Memory-based cache with automatic cleanup</li>
                    <li>• Database persistence for long-term storage</li>
                    <li>• Cache hit rate: ~72% average</li>
                  </ul>
                </div>
                <div className="space-y-3">
                  <h4 className="font-medium text-sm">Batch Processing</h4>
                  <ul className="text-xs text-muted-foreground space-y-1">
                    <li>• Latest 500 alerts processed only</li>
                    <li>• Batch size of 50 alerts per request</li>
                ...
                <table className="w-full text-sm">
                  <thead>
                    <tr className="border-b">
                      ...
                      <th className="text-left py-2">Avg Inference</th>
                    </tr>
                  </thead>
                  <tbody>
                    <tr className="border-b">
                      <td className="py-2 font-medium">XGBoost</td>
                      <td className="py-2">95.25%</td>
                      <td className="py-2">95.30%</td>
                      <td className="py-2">95.20%</td>
                      <td className="py-2">95.24%</td>
                      <td className="py-2">15.2ms</td>
                    </tr>
                    <tr className="border-b">
                      <td className="py-2 font-medium">Random Forest</td>
                      <td className="py-2">93.56%</td>
                      <td className="py-2">93.80%</td>
                      <td className="py-2">93.40%</td>
                      <td className="py-2">93.55%</td>
                      <td className="py-2">12.8ms</td>
                    </tr>
                    <tr>
                      <td className="py-2 font-medium">Logistic Regression</td>
                      <td className="py-2">95.25%</td>
                      <td className="py-2">95.40%</td>
                      <td className="py-2">95.10%</td>
                      <td className="py-2">95.18%</td>
                      <td className="py-2">8.5ms</td>
                    </tr>
                  </tbody>
                </table>
              </div>
            ...
            <div>
              ...
              <div className="grid md:grid-cols-2 gap-4 text-sm">
                <div>
                  <h4 className="font-medium mb-2">Raw Features</h4>
                  <ul className="text-xs text-muted-foreground space-y-1">
                    <li>• Failed login count</li>
                    <li>• Bytes transferred</li>
                    <li>• IP reputation score</li>
                    <li>• Alert frequency</li>
                    <li>• Time window</li>
                    <li>• Alert type (encoded)</li>
                  </ul>
                </div>
                <div>
                  <h4 className="font-medium mb-2">Derived Features</h4>
                  <ul className="text-xs text-muted-foreground space-y-1">
                    <li>• Login rate (logins/time)</li>
                    <li>• Bytes per alert</li>
                    <li>• Threat index (reputation × frequency × rate)</li>
                    <li>• Log-transformed bytes</li>
                    <li>• Log-transformed logins</li>
                  </ul>
                </div>
              </div>
            </div>
