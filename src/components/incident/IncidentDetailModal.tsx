...
import { FileText, Clock, Info, ShieldCheck, Brain } from 'lucide-react';
import { MLInsightsSection } from './MLInsightsSection';
                ...
                <Tabs defaultValue="overview" className="flex-1 flex flex-col overflow-hidden">
                    <div className="px-6 py-2 border-b bg-muted/40">
                        <TabsList>
                            ...
                            <TabsTrigger value="ml-insights" className="gap-2"><Brain className="h-4 w-4 text-primary" /> ML Analysis</TabsTrigger>
